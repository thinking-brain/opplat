...
namespace Opplat.Modules.Inventory.Domain.Services;
...
public class ProductMovementService : BaseService<ProductMovement, string>, IProductMovementService
{
    readonly IMovementTypeService _movementTypeService;
    readonly IProductRepository _productRepo;
    readonly IStorageRepository _storageRepo;
    public ProductMovementService(IMovementsRepository repo, IMovementTypeService movementTypeService,
        IProductRepository productRepo, IStorageRepository storageRepo, ILogger<ProductMovement> logger) : base(repo, logger)
    {
