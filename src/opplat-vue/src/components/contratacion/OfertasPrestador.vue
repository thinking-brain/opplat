  ...
  methods: {
    getOfertasFromApi() {
      const url = api.getUrl(
        "contratacion",
        `Contratos?tipoTramite=oferta&cliente=false&username=${this.username}&roles=${this.roles}&estadoJuridico=${this.estadoJuridico}&estadoEconomico=${this.estadoEconomico}&estadoComiteCont=${this.estadoComiteCont}`
      );
      this.axios.get(url).then(
        response => {
          this.textByfiltro = "Ofertas Prestador";
