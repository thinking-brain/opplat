            ...
            <thead>
              <tr>
                <th colspan="11" class="blue darken-2 white--text">
                  <h2>Ofertas del Año {{new Date().getFullYear()}}</h2>
                </th>
              </tr>
            </thead>
            <tbody>
...
export default {
  ...
  created() {
    ...
    this.getDashboardOfertasFromApi();
  },
  methods: {
    getDashboardOfertasFromApi() {
      const url = api.getUrl("contratacion", "contratos/DashboardOfertas");
