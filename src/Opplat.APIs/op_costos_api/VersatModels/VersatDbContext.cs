...
namespace op_costos_api.VersatModels
{
    public class VersatDbContext : DbContext
    {
        ...
        public DbSet<op_costos_api.VersatModels.GenPeriodo> GenPeriodo { get; set; }
        public DbSet<op_costos_api.VersatModels.ConCuentanat> ConCuentanat { get; set; }
        public DbSet<op_costos_api.VersatModels.CosCentro> CosCentro { get; set; }
        public DbSet<op_costos_api.VersatModels.ConCuenta> ConCuenta { get; set; }
        public DbSet<op_costos_api.VersatModels.CosElementogasto> CosElementogasto { get; set; }
        public DbSet<op_costos_api.VersatModels.CosSubelementogasto> CosSubelementogasto { get; set; }
        public DbSet<op_costos_api.VersatModels.GenUnidadcontable> GenUnidadcontable { get; set; }
        public DbSet<op_costos_api.VersatModels.OptCuentaCentroSubPeriodo> OptCuentaCentroSubPeriodo { get; set; }
        public DbSet<op_costos_api.VersatModels.ConCuentamoneda> ConCuentamoneda { get; set; }
        public DbSet<op_costos_api.VersatModels.GenMoneda> GenMoneda { get; set; }
        public DbSet<op_costos_api.VersatModels.CosCuentasAsociadas> CosCuentasAsociadas { get; set; }
        public DbSet<op_costos_api.VersatModels.CosPartida> CosPartida { get; set; }
        public DbSet<op_costos_api.VersatModels.OptCuentaCentroPeriodo> OptCuentaCentroPeriodo { get; set; }
        public DbSet<op_costos_api.VersatModels.OptCuentaPeriodo> OptCuentaPeriodo { get; set; }
        public DbSet<op_costos_api.VersatModels.OptCuentaPeriodoOK> OptCuentaPeriodoOK { get; set; }
        public DbSet<op_costos_api.VersatModels.NomAsiento> NomAsiento { get; set; }
        public DbSet<op_costos_api.VersatModels.NomAsientoGasto> NomAsientoGasto { get; set; }
        public DbSet<op_costos_api.VersatModels.NomDocumento> NomDocumento { get; set; }
        public DbSet<op_costos_api.VersatModels.NomDocumentoDetallePago> NomDocumentoDetallePago { get; set; }
        public DbSet<op_costos_api.VersatModels.NomPeriodopago> NomPeriodopago { get; set; }
        public DbSet<op_costos_api.VersatModels.NomTipoDocumento> NomTipoDocumento { get; set; }
