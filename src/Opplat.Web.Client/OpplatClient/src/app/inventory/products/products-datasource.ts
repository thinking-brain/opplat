  ...
  private getSortedData(data: Product[]): Product[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        case 'description': return compare(+a.unitOfMeasurement.abbreviation, +b.unitOfMeasurement.abbreviation, isAsc);
        case 'description': return compare(+a.group.description, +b.group.description, isAsc);
        default: return 0;
      }
    });
  }
