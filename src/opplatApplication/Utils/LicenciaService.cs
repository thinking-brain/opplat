...
{
    private static LicenciaService _service = null!;
    private Licencia _licencia = null!;

    IConfiguration _config = null!;

    IWebHostEnvironment _enviroment;

    public LicenciaService(IConfiguration config, IWebHostEnvironment enviroment)
    {
        _config = config;
