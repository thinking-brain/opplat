...
namespace RhWebApi.VersatModels
{
    public class VersatDbContext : DbContext
    {
        ...
        public DbSet<RhWebApi.VersatModels.GenPeriodo> GenPeriodo { get; set; }
        public DbSet<RhWebApi.VersatModels.ConCuentanat> ConCuentanat { get; set; }
        public DbSet<RhWebApi.VersatModels.CosCentro> CosCentro { get; set; }
        public DbSet<RhWebApi.VersatModels.ConCuenta> ConCuenta { get; set; }
        public DbSet<RhWebApi.VersatModels.CosElementogasto> CosElementogasto { get; set; }
        public DbSet<RhWebApi.VersatModels.CosSubelementogasto> CosSubelementogasto { get; set; }
        public DbSet<RhWebApi.VersatModels.GenUnidadcontable> GenUnidadcontable { get; set; }
        public DbSet<RhWebApi.VersatModels.OptCuentaCentroSubPeriodo> OptCuentaCentroSubPeriodo { get; set; }
        public DbSet<RhWebApi.VersatModels.ConCuentamoneda> ConCuentamoneda { get; set; }
        public DbSet<RhWebApi.VersatModels.GenMoneda> GenMoneda { get; set; }
        public DbSet<RhWebApi.VersatModels.CosCuentasAsociadas> CosCuentasAsociadas { get; set; }
        public DbSet<RhWebApi.VersatModels.CosPartida> CosPartida { get; set; }
        public DbSet<RhWebApi.VersatModels.OptCuentaCentroPeriodo> OptCuentaCentroPeriodo { get; set; }
        public DbSet<RhWebApi.VersatModels.OptCuentaPeriodo> OptCuentaPeriodo { get; set; }
        public DbSet<RhWebApi.VersatModels.OptCuentaPeriodoOK> OptCuentaPeriodoOK { get; set; }
        public DbSet<RhWebApi.VersatModels.NomAsiento> NomAsiento { get; set; }
        public DbSet<RhWebApi.VersatModels.NomAsientoGasto> NomAsientoGasto { get; set; }
        public DbSet<RhWebApi.VersatModels.NomDocumento> NomDocumento { get; set; }
        public DbSet<RhWebApi.VersatModels.NomDocumentoDetallePago> NomDocumentoDetallePago { get; set; }
        public DbSet<RhWebApi.VersatModels.NomPeriodopago> NomPeriodopago { get; set; }
        public DbSet<RhWebApi.VersatModels.NomTipoDocumento> NomTipoDocumento { get; set; }
