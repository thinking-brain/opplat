...
{
    public partial class trasladoUnidadOrganizativa : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_grupos_escalas_categorias_ocupacionales_CategoriaOcupacionalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_actividades_de_contratos_actividades_laborales_ActividadLaboralId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_unidades_organizativas_tipos_de_unidad_organizativa_TipoUnidadOrganizativaId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_puestos_de_trabajos_unidades_organizativas_UnidadOrganizativaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TrabajadorId = table.Column<int>(nullable: false),
                    PuestoDeTrabajoId = table.Column<int>(nullable: false),
                    FechaInicio = table.Column<DateTime>(nullable: false),
                    FechaTerminado = table.Column<DateTime>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_historicos_de_puestos_de_trabajos_puestos_de_trabajos_PuestoDeTrabajoId",
                        column: x => x.PuestoDeTrabajoId,
                        principalTable: "puestos_de_trabajos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
