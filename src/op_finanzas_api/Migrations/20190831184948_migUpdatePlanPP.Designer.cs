...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("op_finanzas_api.Models.ConceptoCuentas", b =>
                {
            ...
            modelBuilder.Entity("op_finanzas_api.Models.ConceptoPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("op_finanzas_api.Models.ConceptoCuentas", b =>
                {
                    b.HasOne("op_finanzas_api.Models.ConceptoPlan")
                        .WithMany("Cuentas")
            ...
            modelBuilder.Entity("op_finanzas_api.Models.PlanPronosticoProductivo", b =>
                {
                    b.HasOne("op_finanzas_api.Models.ConceptoPlan", "ConceptoPlan")
                        .WithMany()
                        .HasForeignKey("ConceptoPlanId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
