...
[assembly: HostingStartup(typeof(op_finanzas_api.Startup))]

namespace op_finanzas_api
{
    public class Startup: IHostingStartup
    {
        ...
        public void ConfigureServices(WebHostBuilderContext context, IServiceCollection services)
        {
            ...
            services.AddDbContext<ApiDbContext>(options =>
                    options.UseSqlServer(context.Configuration.GetConnectionString("ApiDbContext"), b => b.MigrationsAssembly("op_finanzas_api")));
