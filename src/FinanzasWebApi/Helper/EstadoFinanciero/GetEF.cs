...
namespace FinanzasWebApi.Helper.EstadoFinanciero
{
    public class GetEF
    {
        ...
        public List<EstadoFinancieroJsVM> estadoFinanciero5920(int year, int meses)
        {
            ...
            //Activo Circulante
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Activo Circulante", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C5" });
            ...
            //Total de Inventario
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Total de Inventario", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C27" });
            ...
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Activos a Largo Plazo", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C55" });
            ...
            //Activos Diferidos
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Activos Diferidos", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C73" });
            ...
            //Otros Activos
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Otros Activos", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C78" });
            ...
            //TOTAL DEL ACTIVO 
            estado.Add(new EstadoFinancieroJsVM { Concepto = "TOTAL DEL ACTIVO", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C91" });

            //PASIVO 
            estado.Add(new EstadoFinancieroJsVM { Concepto = "PASIVO", EFE = "5920", Encabezado = true, Mes = meses, Real = 0, Plan = 0, Celda = "C92" });

            //Pasivo Circulante 
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Pasivo Circulante", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C93" });
            ...
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Pasivos a Largo Plazo", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C115" });
            ...
            //Pasivos Diferidos
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Pasivos Diferidos", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C123" });
            ...
            //Otros Pasivos
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Otros Pasivos", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C126" });
            ...
            //Total de Pasivos
            estado.Add(new EstadoFinancieroJsVM { Concepto = "TOTAL PASIVO", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C132" });

            //Patrimonio Neto
            estado.Add(new EstadoFinancieroJsVM { Concepto = "PATRIMONIO NETO O CAPITAL CONTABLE", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C133" });
            ...
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Capital Social Suscrito y Pagado", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C136" });
            ...
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Resultado del Período", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C155" });
            estado.Add(new EstadoFinancieroJsVM { Concepto = "TOTAL  PATRIMONIO NETO", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C156" });
            estado.Add(new EstadoFinancieroJsVM { Concepto = "TOTAL DEL PASIVO Y PATRIMONIO NETO O CAPITAL CONTABLE", Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C157" });
        ...
        public List<EstadoFinancieroJsVM> estadoFinanciero5920Report(int year, int meses)
        {
            var config = System.IO.File.ReadAllText("../FinanzasWebApi/Helper/EstadoFinanciero/Configs/Config5920Hoja.json");
            List<EfViewModel> configs = JsonConvert.DeserializeObject<List<EfViewModel>>(config);
            var estado = new List<EstadoFinancieroJsVM>();
            var planes = GetPlanesPeriodo.Get(year, _config);

            //Activo Circulante
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Activo Circulante", Encabezado = true, EFE = "5920", Visible = true, Mes = meses, Real = 0, Plan = 0, Celda = "C5" });
            ...
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Activo Circulante")))
            {
                foreach (var item2 in concepto.conceptos)
                {
                    ...
                    estadoTemp.EFE = "5920";
                    estadoTemp.Plan = planEnMes;
                    estadoTemp.Visible = item2.visible;
            ...
            //Total de Inventario
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Total de Inventario", Encabezado = true, EFE = "5920", Visible = true, Mes = meses, Real = 0, Plan = 0, Celda = "C27" });
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Total de Inventario")))
            {
                foreach (var item2 in concepto.conceptos)
                {
            ...
            //Activos a Largo Plazo
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Activos a Largo Plazo", Encabezado = true, Visible = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C55" });
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Activos a Largo Plazo")))
            {
                foreach (var item2 in concepto.conceptos)
                {
            ...
            //Activos Fijos
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Activos Fijos", EFE = "5920", Encabezado = true, Visible = true, Mes = meses, Real = 0, Plan = 0, Celda = "C60" });
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Activos Fijos")))
            {
                foreach (var item2 in concepto.conceptos)
                {
            ...
            //Activos Diferidos
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Activos Diferidos", Encabezado = true, Visible = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C73" });
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Activos Diferidos")))
            {
                foreach (var item2 in concepto.conceptos)
                {
            ...
            //Otros Activos
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Otros Activos", Encabezado = true, Visible = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C78" });
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Otros Activos")))
            {
                foreach (var item2 in concepto.conceptos)
                {
            ...
            //Pasivo Circulante 
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Pasivo Circulante", Encabezado = true, Visible = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C93" });
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Pasivo Circulante")))
            {
                foreach (var item2 in concepto.conceptos)
                {
            ...
            //Pasivos a Largo Plazo
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Pasivos a Largo Plazo", Encabezado = true, Visible = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C115" });
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Pasivos a Largo Plazo")))
            {
                foreach (var item2 in concepto.conceptos)
                {
            ...
            //Pasivos Diferidos
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Pasivos Diferidos", Encabezado = true, Visible = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C123" });
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Pasivos Diferidos")))
            {
                foreach (var item2 in concepto.conceptos)
                {
            ...
            //Otros Pasivos
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Otros Pasivos", Encabezado = true, Visible = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C126" });
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Otros Pasivos")))
            {
                foreach (var item2 in concepto.conceptos)
                {
            ...
            //Total de Pasivos
            estado.Add(new EstadoFinancieroJsVM { Concepto = "TOTAL PASIVO", Encabezado = true, Visible = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C132" });
            ...
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Capital Social Suscrito y Pagado", Encabezado = false, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C136" });
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Capital Social Suscrito y Pagado")))
            {
                foreach (var item2 in concepto.conceptos)
                {
            ...
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Resultado del Período", Visible = true, Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C155" });
            estado.Add(new EstadoFinancieroJsVM { Concepto = "TOTAL  PATRIMONIO NETO", Visible = true, Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C156" });
            estado.Add(new EstadoFinancieroJsVM { Concepto = "TOTAL DEL PASIVO Y PATRIMONIO NETO O CAPITAL CONTABLE", Visible = true, Encabezado = true, EFE = "5920", Mes = meses, Real = 0, Plan = 0, Celda = "C157" });
        ...
        {
            var config = System.IO.File.ReadAllText("../FinanzasWebApi/Helper/EstadoFinanciero/Configs/Config5921.json");
            List<EfViewModel> configs = JsonConvert.DeserializeObject<List<EfViewModel>>(config);
            var estado = new List<EstadoFinancieroJsVM>();
            var planes = GetPlanesPeriodo.Get(year, _config);

            //Ventas Netas
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Ventas Netas")))
            {
                foreach (var item2 in concepto.conceptos)
                {
                    var estadoTemp = new EstadoFinancieroJsVM();
                ...
                estado.Add(new EstadoFinancieroJsVM { Concepto = "Ventas Netas", Encabezado = true, EFE = "5921", Mes = meses, Real = 0, Plan = 0, Celda = "C15" });
            }

            //Utilidad o Pérdida Bruta en Ventas
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Utilidad o Pérdida Bruta en Ventas")))
            {
                foreach (var item2 in concepto.conceptos)
                {
                    var estadoTemp = new EstadoFinancieroJsVM();
                ...
                estado.Add(new EstadoFinancieroJsVM { Concepto = "Utilidad o Pérdida Bruta en Ventas", Encabezado = true, EFE = "5921", Mes = meses, Real = 0, Plan = 0, Celda = "C19" });
            }


            //Utilidad o Pérdida Neta en Ventas
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Utilidad o Pérdida Neta en Ventas")))
            {
                foreach (var item2 in concepto.conceptos)
                {
                    var estadoTemp = new EstadoFinancieroJsVM();
                ...
                estado.Add(new EstadoFinancieroJsVM { Concepto = "Utilidad o Pérdida Neta en Ventas", Encabezado = true, EFE = "5921", Mes = meses, Real = 0, Plan = 0, Celda = "C21" });
            }

            //Utilidad o Pérdida en Operaciones
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Utilidad o Pérdida en Operaciones")))
            {
                foreach (var item2 in concepto.conceptos)
                {
                    var estadoTemp = new EstadoFinancieroJsVM();
                ...
                estado.Add(new EstadoFinancieroJsVM { Concepto = "Utilidad o Pérdida en Operaciones", EFE = "5921", Mes = meses, Real = 0, Plan = 0, Celda = "C25" });
            }

            //Utilidad o Pérdida antes de Impuesto
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Utilidad o Pérdida antes de Impuesto")))
            {
                foreach (var item2 in concepto.conceptos)
                {
                    var estadoTemp = new EstadoFinancieroJsVM();
                ...
                estado.Add(new EstadoFinancieroJsVM { Concepto = "Utilidad o Pérdida antes de Impuesto", Encabezado = true, EFE = "5921", Mes = meses, Real = 0, Plan = 0, Celda = "C48" });
            }


            var ventasNetas = estado.SingleOrDefault(s => s.Concepto.Equals("Ventas Netas"));
            decimal C9 = estado.SingleOrDefault(s => s.Celda.Equals("C9")).Real;
            decimal C10 = estado.SingleOrDefault(s => s.Celda.Equals("C10")).Real;
            decimal C11 = estado.SingleOrDefault(s => s.Celda.Equals("C11")).Real;
            decimal C12 = estado.SingleOrDefault(s => s.Celda.Equals("C12")).Real;
            decimal C13 = estado.SingleOrDefault(s => s.Celda.Equals("C13")).Real;
            decimal C14 = estado.SingleOrDefault(s => s.Celda.Equals("C14")).Real;
            decimal ventasNetasValue = (C9 + C10 + C11 + C12) - C13 - C14;
            ventasNetas.Real = ventasNetasValue;
            string ventasNetasConcept = FixText.Fix("Ventas Netas");
            var ventasNetasPlanEnMes = planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(ventasNetasConcept.ToUpper().Trim())) != null ? planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(ventasNetasConcept.ToUpper().Trim()))[meses] : 0M;
            ventasNetas.Plan = ventasNetasPlanEnMes;

            var utilidadPerdidaBrutaEnVentas = estado.SingleOrDefault(s => s.Concepto.Equals("Utilidad o Pérdida Bruta en Ventas"));
            decimal C15 = estado.SingleOrDefault(s => s.Celda.Equals("C15")).Real;
            decimal C16 = estado.SingleOrDefault(s => s.Celda.Equals("C16")).Real;
            decimal C17 = estado.SingleOrDefault(s => s.Celda.Equals("C17")).Real;
            decimal C18 = estado.SingleOrDefault(s => s.Celda.Equals("C18")).Real;
            decimal utilidadPerdidaBrutaEnVentasValue = C15 - C16 - C17 - C18;
            utilidadPerdidaBrutaEnVentas.Real = utilidadPerdidaBrutaEnVentasValue;
            string utilidadPerdidaBrutaEnVentasConcept = FixText.Fix("Utilidad o Pérdida Bruta en Ventas");
            var utilidadPerdidaBrutaEnVentasPlanEnMes = planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaBrutaEnVentasConcept.ToUpper().Trim())) != null ? planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaBrutaEnVentasConcept.ToUpper().Trim()))[meses] : 0M;
            utilidadPerdidaBrutaEnVentas.Plan = utilidadPerdidaBrutaEnVentasPlanEnMes;

            var utilidadPerdidaNetaEnVentas = estado.SingleOrDefault(s => s.Concepto.Equals("Utilidad o Pérdida Neta en Ventas"));
            string utilidadPerdidaNetaEnVentasConcept = FixText.Fix("Utilidad o Pérdida Neta en Ventas");
            var utilidadPerdidaNetaEnVentasPlanEnMes = planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaNetaEnVentasConcept.ToUpper().Trim())) != null ? planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaNetaEnVentasConcept.ToUpper().Trim()))[meses] : 0M;
            utilidadPerdidaNetaEnVentas.Plan = utilidadPerdidaNetaEnVentasPlanEnMes;
            decimal C19 = estado.SingleOrDefault(s => s.Celda.Equals("C19")).Real;
            decimal C20 = estado.SingleOrDefault(s => s.Celda.Equals("C20")).Real;
            decimal utilidadPerdidaNetaEnVentasValue = C19 - C20;
            utilidadPerdidaNetaEnVentas.Real = utilidadPerdidaNetaEnVentasValue;

            var utilidadPerdidaEnOperaciones = estado.SingleOrDefault(s => s.Concepto.Equals("Utilidad o Pérdida en Operaciones"));
            string utilidadPerdidaEnOperacionesConcept = FixText.Fix("Utilidad o Pérdida en Operaciones");
            var utilidadPerdidaEnOperacionesPlanEnMes = planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaEnOperacionesConcept.ToUpper().Trim())) != null ? planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaEnOperacionesConcept.ToUpper().Trim()))[meses] : 0M;
            utilidadPerdidaEnOperaciones.Plan = utilidadPerdidaEnOperacionesPlanEnMes;
            decimal C22 = estado.SingleOrDefault(s => s.Celda.Equals("C22")).Real;
            decimal C23 = estado.SingleOrDefault(s => s.Celda.Equals("C23")).Real;
            decimal C24 = estado.SingleOrDefault(s => s.Celda.Equals("C24")).Real;
            decimal utilidadPerdidaEnOperacionesValue = C12 - (C22 + C23 + C24);
            utilidadPerdidaEnOperaciones.Real = utilidadPerdidaEnOperacionesValue;

            var utilidadPerdidaAntesDeImpuesto = estado.SingleOrDefault(s => s.Concepto.Equals("Utilidad o Pérdida antes de Impuesto"));
            string utilidadPerdidaAntesDeImpuestoConcept = FixText.Fix("Utilidad o Pérdida antes de Impuesto");
            var utilidadPerdidaAntesDeImpuestoPlanEnMes = planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaAntesDeImpuestoConcept.ToUpper().Trim())) != null ? planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaAntesDeImpuestoConcept.ToUpper().Trim()))[meses] : 0M;
            utilidadPerdidaAntesDeImpuesto.Plan = utilidadPerdidaAntesDeImpuestoPlanEnMes;
            decimal C25 = estado.SingleOrDefault(s => s.Celda.Equals("C25")).Real;
            decimal C26 = estado.SingleOrDefault(s => s.Celda.Equals("C26")).Real;
            decimal C27 = estado.SingleOrDefault(s => s.Celda.Equals("C27")).Real;
            decimal C28 = estado.SingleOrDefault(s => s.Celda.Equals("C28")).Real;
            decimal C29 = estado.SingleOrDefault(s => s.Celda.Equals("C29")).Real;
            decimal C30 = estado.SingleOrDefault(s => s.Celda.Equals("C30")).Real;
            decimal C31 = estado.SingleOrDefault(s => s.Celda.Equals("C31")).Real;
            ...
            decimal utilidadPerdidaAntesDeImpuestoValue = (C25 - (C26 + C27 + C28 + C29 + C30 + C31 + C32 + C33 + C34 + C35 + C36 + C37 + C38)) + (C39 + C40 + C41 + C42 + C43 + C44 + C45 + C46 + C47);
            utilidadPerdidaAntesDeImpuesto.Real = utilidadPerdidaAntesDeImpuestoValue;
        ...
        public List<EstadoFinancieroJsVM> estadoFinanciero5921Hoja(int year, int meses)
        {
            ...
            //Ventas  (900-913)
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Ventas  (900-913)", Encabezado = true, Visible = true, EFE = "5921", Mes = meses, Real = 0, Plan = 0, Celda = "C4" });
            var ventas = estado.SingleOrDefault(s => s.Concepto.Equals("Ventas  (900-913)"));
            var listCuentasVentas = new List<int> { 900, 901, 902, 903, 904, 905, 906, 907, 908, 909, 910, 911, 912, 913 };
            var planEnMesventas = planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(ventas.Concepto.ToUpper().Trim())) != null ? planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(ventas.Concepto.ToUpper().Trim()))[meses] : 0M;
            ventas.Plan = planEnMesventas;
            foreach (var cuenta in listCuentasVentas)
            {
                string cta = Convert.ToString(cuenta);
                var cache = _context.Set<CacheCuentaPeriodo>().SingleOrDefault(c => c.Cuenta == cta && c.Mes == meses && c.Year == year);
                if (cache != null)
                {
                    ventas.Real = ventas.Real + cache.Saldo;
                }
            }

            //Elementos
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Elementos")))
            {
                foreach (var item2 in concepto.conceptos)
                {
                    var estadoTemp = new EstadoFinancieroJsVM();
            ...
            //Ventas netas 
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Ventas netas", Encabezado = true, Visible = true, EFE = "5921", Mes = meses, Real = 0, Plan = 0, Celda = "C12" });

            var ventasNetas = estado.SingleOrDefault(s => s.Concepto.Equals("Ventas netas"));
            string ventasNetasConcept = FixText.Fix("Ventas netas");
            var ventasNetasPlanEnMes = planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(ventasNetasConcept.ToUpper().Trim())) != null ? planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(ventasNetasConcept.ToUpper().Trim()))[meses] : 0M;
            ventasNetas.Plan = ventasNetasPlanEnMes;
            decimal C4 = estado.SingleOrDefault(s => s.Celda.Equals("C4")).Real;
            decimal C7 = estado.SingleOrDefault(s => s.Celda.Equals("C7")).Real;
            decimal C8 = estado.SingleOrDefault(s => s.Celda.Equals("C8")).Real;
            decimal C9 = estado.SingleOrDefault(s => s.Celda.Equals("C9")).Real;
            decimal C10 = estado.SingleOrDefault(s => s.Celda.Equals("C10")).Real;
            decimal C11 = estado.SingleOrDefault(s => s.Celda.Equals("C11")).Real;
            decimal ventasNetasValue = (C4 + C7 + C8 + C9) - C10 - C11;
            ventasNetas.Real = ventasNetasValue;

            //Elementos2
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Elementos2")))
            {
                foreach (var item2 in concepto.conceptos)
                {
                    var estadoTemp = new EstadoFinancieroJsVM();
            ...
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Utilidad o perdida bruta en ventas", Encabezado = true, Visible = true, EFE = "5921", Mes = meses, Real = 0, Plan = 0, Celda = "C16" });

            var utilidadPerdidaBrutaEnVentas = estado.SingleOrDefault(s => s.Concepto.Equals("Utilidad o perdida bruta en ventas"));
            string utilidadPerdidaBrutaEnVentasConcept = FixText.Fix("Utilidad o perdida bruta en ventas");
            var utilidadPerdidaBrutaEnVentasPlanEnMes = planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaBrutaEnVentasConcept.ToUpper().Trim())) != null ? planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaBrutaEnVentasConcept.ToUpper().Trim()))[meses] : 0M;
            utilidadPerdidaBrutaEnVentas.Plan = utilidadPerdidaBrutaEnVentasPlanEnMes;
            decimal C12 = estado.SingleOrDefault(s => s.Celda.Equals("C12")).Real;
            decimal C13 = estado.SingleOrDefault(s => s.Celda.Equals("C13")).Real;
            decimal C14 = estado.SingleOrDefault(s => s.Celda.Equals("C14")).Real;
            decimal C15 = estado.SingleOrDefault(s => s.Celda.Equals("C15")).Real;
            decimal utilidadPerdidaBrutaEnVentasValue = C12 - C13 - C14 - C15;
            utilidadPerdidaBrutaEnVentas.Real = utilidadPerdidaBrutaEnVentasValue;

            //Elementos3
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Elementos3")))
            {
                foreach (var item2 in concepto.conceptos)
                {
                    var estadoTemp = new EstadoFinancieroJsVM();
            ...
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Utilidad o perdida en ventas", Encabezado = true, Visible = true, EFE = "5921", Mes = meses, Real = 0, Plan = 0, Celda = "C18" });

            var utilidadPerdidaEnVentas = estado.SingleOrDefault(s => s.Concepto.Equals("Utilidad o perdida en ventas"));
            string utilidadPerdidaEnVentasConcept = FixText.Fix("Utilidad o perdida en ventas");
            var utilidadPerdidaEnVentasPlanEnMes = planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaEnVentasConcept.ToUpper().Trim())) != null ? planes.SingleOrDefault(s => s.Concepto.ToUpper().Trim().Equals(utilidadPerdidaEnVentasConcept.ToUpper().Trim()))[meses] : 0M;
            utilidadPerdidaEnVentas.Plan = utilidadPerdidaEnVentasPlanEnMes;
            decimal C16 = estado.SingleOrDefault(s => s.Celda.Equals("C16")).Real;
            decimal C17 = estado.SingleOrDefault(s => s.Celda.Equals("C17")).Real;
            decimal utilidadPerdidaEnVentasValue = C16 - C17;
            utilidadPerdidaEnVentas.Real = utilidadPerdidaEnVentasValue;

            //Elementos4 SUBELEMENTOS




            foreach (var concepto in configs.Where(s => s.concepto.Equals("Elementos4")))
            {
                foreach (var item2 in concepto.conceptos)
                {
                    var estadoTemp = new EstadoFinancieroJsVM();
                    ...
                    foreach (var cuenta in item2.cuentas)
                    {
                        string subElemento = Convert.ToString(cuenta);
        ...
        public List<EstadoFinancieroJsVM> estadoFinanciero5922(int year, int meses)
        {
            ...
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Ventas", Encabezado = true, EFE = "5922", Mes = meses, Real = 0, Plan = 0, Celda = "C4" });
            estado.Add(new EstadoFinancieroJsVM { Concepto = "Materias primas y materiales", Encabezado = true, EFE = "5922", Mes = meses, Real = 0, Plan = 0, Celda = "C5" });

            //Materias primas y materiales
            foreach (var concepto in configs.Where(s => s.concepto.Equals("Materias primas y materiales")))
            {
                foreach (var item2 in concepto.conceptos)
                {
                    var estadoTemp = new EstadoFinancieroJsVM();
                    ...
                    estadoTemp.EFE = "5921";
                    estadoTemp.Plan = planEnMes;
                    estadoTemp.Elemento = concepto.elemento;
            ...
            decimal C48 = estado.SingleOrDefault(s => s.Celda.Equals("C48")).Real;
            decimal C49 = estado.SingleOrDefault(s => s.Celda.Equals("C49")).Real;
            decimal utilidadPerdidaAntesDeImpuestoValue = (C25 - (C26 + C27 + C28 + C29 + C30 + C31 + C32 + C33 + C34 + C35 + C36 + C37 + C38)) + (C39 + C40 + C41 + C42 + C43 + C44 + C45 + C46 + C47 + C48 + C49);
            utilidadPerdidaAntesDeImpuesto.Real = utilidadPerdidaAntesDeImpuestoValue;
