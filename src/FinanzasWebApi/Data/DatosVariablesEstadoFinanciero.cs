    ...
    public class DatosVariablesEstadoFinanciero
    {
        public static List<dynamic> Datos()
        {
            var data = new List<dynamic> {
                ...
                new { Dato = "Adeudos del Presupuesto del EstadoOrden", Valor = "164,165,166"},
               ...
               //Activos Fijos
                ...
                new { Dato = "Obligaciones con el Presupuesto del EstadoOrden", Valor = "440,441,442,443,444,445,446,447,448,449"},
