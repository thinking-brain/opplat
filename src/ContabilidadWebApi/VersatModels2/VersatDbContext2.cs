...
namespace ContabilidadWebApi.VersatModels2
{
    public class VersatDbContext2 : DbContext
    {
        ...
        public DbSet<ContabilidadWebApi.VersatModels2.GenPeriodo> GenPeriodo { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.CosCentro> CosCentro { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.ConCuenta> ConCuenta { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.CosElementogasto> CosElementogasto { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.CosSubelementogasto> CosSubelementogasto { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.GenUnidadcontable> GenUnidadcontable { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.OptCuentaCentroSubPeriodo> OptCuentaCentroSubPeriodo { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.ConCuentamoneda> ConCuentamoneda { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.GenMoneda> GenMoneda { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.CosCuentasAsociadas> CosCuentasAsociadas { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.CosPartida> CosPartida { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.OptCuentaPeriodo> OptCuentaPeriodo { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.NomAsiento> NomAsiento { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.NomAsientoGasto> NomAsientoGasto { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.NomDocumento> NomDocumento { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.NomDocumentoDetallePago> NomDocumentoDetallePago { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.NomPeriodopago> NomPeriodopago { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.NomTipoDocumento> NomTipoDocumento { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.FinAsiento> FinAsiento { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.FinAsientoAnticipo> FinAsientoAnticipo { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.FinDcAnticipo> FinDcAnticipo { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels2.FinDocumento> FinDocumento { get; set; }
