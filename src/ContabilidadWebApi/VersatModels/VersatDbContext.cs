...
namespace ContabilidadWebApi.VersatModels
{
    public class VersatDbContext : DbContext
    {
        ...
        public DbSet<ContabilidadWebApi.VersatModels.GenPeriodo> GenPeriodo { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.ConCuentanat> ConCuentanat { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.CosCentro> CosCentro { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.ConCuenta> ConCuenta { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.CosElementogasto> CosElementogasto { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.CosSubelementogasto> CosSubelementogasto { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.GenUnidadcontable> GenUnidadcontable { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.OptCuentaCentroSubPeriodo> OptCuentaCentroSubPeriodo { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.ConCuentamoneda> ConCuentamoneda { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.GenMoneda> GenMoneda { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.CosCuentasAsociadas> CosCuentasAsociadas { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.CosPartida> CosPartida { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.OptCuentaCentroPeriodo> OptCuentaCentroPeriodo { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.OptCuentaPeriodo> OptCuentaPeriodo { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.OptCuentaPeriodoOK> OptCuentaPeriodoOK { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.NomAsiento> NomAsiento { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.NomAsientoGasto> NomAsientoGasto { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.NomDocumento> NomDocumento { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.NomDocumentoDetallePago> NomDocumentoDetallePago { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.NomPeriodopago> NomPeriodopago { get; set; }
        public DbSet<ContabilidadWebApi.VersatModels.NomTipoDocumento> NomTipoDocumento { get; set; }
