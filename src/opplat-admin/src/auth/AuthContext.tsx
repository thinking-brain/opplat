...
import { buildAdminUser, getTenantIdentifierFromUser, persistTenantIdentifier } from './claims';
import { oidcSettings, onSigninCallback } from './oidc';
...
const InnerAuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const user = useMemo(() => (oidc.user ? buildAdminUser(oidc.user) : null), [oidc.user]);
...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => (
  <OidcProvider {...oidcSettings} onSigninCallback={onSigninCallback}>
