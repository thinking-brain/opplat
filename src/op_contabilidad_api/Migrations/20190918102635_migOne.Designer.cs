...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.Area", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.CentroCostoArea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.ConceptoCuentas", b =>
                {
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.ConceptoPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.GrupoSubElemento_SubElemento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.GrupoSubelemento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.Plan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.PlanGI", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.PlanPronosticoProductivo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.SubMayor", b =>
                {
                    b.Property<string>("Analisis")
                        .HasMaxLength(20);
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.SubMayorCuenta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.CentroCostoArea", b =>
                {
                    b.HasOne("op_contabilidad_api.Models.Area", "Area")
                        .WithMany()
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.ConceptoCuentas", b =>
                {
                    b.HasOne("op_contabilidad_api.Models.ConceptoPlan")
                        .WithMany("Cuentas")
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.GrupoSubElemento_SubElemento", b =>
                {
                    b.HasOne("op_contabilidad_api.Models.GrupoSubelemento", "GrupoSubelemento")
                        .WithMany()
            ...
            modelBuilder.Entity("op_contabilidad_api.Models.PlanPronosticoProductivo", b =>
                {
                    b.HasOne("op_contabilidad_api.Models.ConceptoPlan", "ConceptoPlan")
                        .WithMany()
                        .HasForeignKey("ConceptoPlanId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
