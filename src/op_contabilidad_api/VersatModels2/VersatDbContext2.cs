...
namespace op_contabilidad_api.VersatModels2
{
    public class VersatDbContext2 : DbContext
    {
        ...
        public DbSet<op_contabilidad_api.VersatModels2.GenPeriodo> GenPeriodo { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.CosCentro> CosCentro { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.ConCuenta> ConCuenta { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.CosElementogasto> CosElementogasto { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.CosSubelementogasto> CosSubelementogasto { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.GenUnidadcontable> GenUnidadcontable { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.OptCuentaCentroSubPeriodo> OptCuentaCentroSubPeriodo { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.ConCuentamoneda> ConCuentamoneda { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.GenMoneda> GenMoneda { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.CosCuentasAsociadas> CosCuentasAsociadas { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.CosPartida> CosPartida { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.OptCuentaPeriodo> OptCuentaPeriodo { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.NomAsiento> NomAsiento { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.NomAsientoGasto> NomAsientoGasto { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.NomDocumento> NomDocumento { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.NomDocumentoDetallePago> NomDocumentoDetallePago { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.NomPeriodopago> NomPeriodopago { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.NomTipoDocumento> NomTipoDocumento { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.FinAsiento> FinAsiento { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.FinAsientoAnticipo> FinAsientoAnticipo { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.FinDcAnticipo> FinDcAnticipo { get; set; }
        public DbSet<op_contabilidad_api.VersatModels2.FinDocumento> FinDocumento { get; set; }
