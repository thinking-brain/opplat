...
namespace Opplat.MainApp.Migrations
{
    ...
    [Migration("20221123231550_AddCostTabs")]
    partial class AddCostTabs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Opplat.Modules.Inventory.Domain.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Opplat.Modules.Inventory.Domain.Entities.ProductClassification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Opplat.Modules.Inventory.Domain.Entities.ProductGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Opplat.Modules.Inventory.Domain.Entities.ProductInventory", b =>
                {
            ...
            modelBuilder.Entity("Opplat.Modules.Inventory.Domain.Entities.ProductMovement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Opplat.Modules.Inventory.Domain.Entities.Storage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.AddedTopping", b =>
                {
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.Annotation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.CostTab", b =>
                {
                    b.Property<Guid>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.CostTabDetail", b =>
                {
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.OrderDetail", b =>
                {
                    b.Property<Guid>("SaleDetailId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.ProductForSale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.ProductTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.SaleDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.Topping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnnotationOrderDetail", b =>
                {
                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.Annotation", null)
                        .WithMany()
                        .HasForeignKey("AnnotationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.OrderDetail", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Opplat.Modules.Inventory.Domain.Entities.Product", b =>
                {
                    b.HasOne("Opplat.Modules.Inventory.Domain.Entities.ProductGroup", "Group")
                        .WithMany()
            ...
            modelBuilder.Entity("Opplat.Modules.Inventory.Domain.Entities.ProductGroup", b =>
                {
                    b.HasOne("Opplat.Modules.Inventory.Domain.Entities.ProductClassification", "Classification")
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("Opplat.Modules.Inventory.Domain.Entities.ProductInventory", b =>
                {
                    b.HasOne("Opplat.Modules.Inventory.Domain.Entities.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Opplat.Modules.Inventory.Domain.Entities.Storage", "Storage")
                        .WithMany()
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.AddedTopping", b =>
                {
                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.SaleDetail", "SaleDetail")
                        .WithMany("Toppings")
                        .HasForeignKey("SaleDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.Topping", "Topping")
                        .WithMany()
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.CostTab", b =>
                {
                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.ProductForSale", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.CostTabDetail", b =>
                {
                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.CostTab", null)
                        .WithMany("Details")
                        .HasForeignKey("CostTabProductId");

                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.ProductForSale", "ProductForSale")
                        .WithMany()
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.Discount", b =>
                {
                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.Sale", "Sale")
                        .WithMany("Discounts")
            ...
            modelBuilder.Entity("Opplat.Modules.Sales.Domain.Entities.OrderDetail", b =>
                {
                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.SaleDetail", "SaleDetail")
                        .WithOne("OrderDetail")
                        .HasForeignKey("Opplat.Modules.Sales.Domain.Entities.OrderDetail", "SaleDetailId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ProductForSaleProductTag", b =>
                {
                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.ProductForSale", null)
                        .WithMany()
                        .HasForeignKey("OnProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.ProductTag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductForSaleTopping", b =>
                {
                    b.HasOne("Opplat.Modules.Sales.Domain.Entities.Topping", null)
                        .WithMany()
